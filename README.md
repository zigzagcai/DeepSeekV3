...
Our implementation is particularly useful for fast prototyping or integration into SFT or RL systems (such as [VeRL](https://github.com/volcengine/verl)/[OpenRLHF](https://github.com/OpenRLHF/OpenRLHF)/[Slime](https://github.com/THUDM/slime)/[Miles](https://github.com/radixark/miles)), and keeps good balance between usability and efficiency.
